...
%   end
  ...
  fprintf ( output_unit, '        </DataArray>\n' );
  fprintf ( output_unit, '        <DataArray type="Float32" NumberOfComponents="3" Name="Re(J)Eddy P2" Format="ascii">\n' );
  for node = 1 : node_num
    fprintf ( output_unit, '        %20.16f  %20.16f  %20.16f\n', real(pen(node,4:6)) );
  end
  fprintf ( output_unit, '        </DataArray>\n' );
  fprintf ( output_unit, '        <DataArray type="Float32" NumberOfComponents="3" Name="Im(J)Eddy P2" Format="ascii">\n' );
  for node = 1 : node_num
    fprintf ( output_unit, '        %20.16f  %20.16f  %20.16f\n', imag(pen(node,4:6)) );
  end  
  fprintf ( output_unit, '        </DataArray>\n' );
  fprintf ( output_unit, '        <DataArray type="Float32" NumberOfComponents="3" Name="Re(J)Eddy P3" Format="ascii">\n' );
  for node = 1 : node_num
    fprintf ( output_unit, '        %20.16f  %20.16f  %20.16f\n', real(pen(node,7:9)) );
  end
  fprintf ( output_unit, '        </DataArray>\n' );
  fprintf ( output_unit, '        <DataArray type="Float32" NumberOfComponents="3" Name="Im(J)Eddy P3" Format="ascii">\n' );
  for node = 1 : node_num
    fprintf ( output_unit, '        %20.16f  %20.16f  %20.16f\n', imag(pen(node,7:9)) );
  end  
  fprintf ( output_unit, '        </DataArray>\n' );  
 ...
 fprintf ( output_unit, '        </DataArray>\n' );
 fprintf ( output_unit, '        <DataArray type="Float32" NumberOfComponents="3" Name="Re(H)Magnetic P2" Format="ascii">\n' );
  for node = 1 : node_num
    fprintf ( output_unit, '        %20.16f  %20.16f  %20.16f\n', real(phen(node,4:6)) );
  end
  fprintf ( output_unit, '        </DataArray>\n' );
  fprintf ( output_unit, '        <DataArray type="Float32" NumberOfComponents="3" Name="Im(H)Magnetic P2" Format="ascii">\n' );
  for node = 1 : node_num
    fprintf ( output_unit, '        %20.16f  %20.16f  %20.16f\n', imag(phen(node,4:6)) );
  end    
 fprintf ( output_unit, '        </DataArray>\n' );
 
  fprintf ( output_unit, '        <DataArray type="Float32" NumberOfComponents="3" Name="Re(H)Magnetic P3" Format="ascii">\n' );
  for node = 1 : node_num
    fprintf ( output_unit, '        %20.16f  %20.16f  %20.16f\n', real(phen(node,7:9)) );
  end
  fprintf ( output_unit, '        </DataArray>\n' );
  fprintf ( output_unit, '        <DataArray type="Float32" NumberOfComponents="3" Name="Im(H)Magnetic P3" Format="ascii">\n' );
  for node = 1 : node_num
    fprintf ( output_unit, '        %20.16f  %20.16f  %20.16f\n', imag(phen(node,7:9)) );
  end    
 fprintf ( output_unit, '        </DataArray>\n' );
