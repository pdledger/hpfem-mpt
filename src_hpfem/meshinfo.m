...
function [nboun,bsido,nelem,intma,npoint,coord,cintma,mat,bcosurf,nsurf,quadlin]=meshinfo(meshdata,...
...
% Connectivities
nbounnew = nboun;
help1(1:nboun,1:5) = bsido(1:nboun,1:5);
...
clear bsido
bsido = help1(1:nbounnew,1:5);


% Set up coordinates
% edge details (not used)
